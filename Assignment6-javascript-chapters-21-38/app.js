...
var check = false;
var pos;
arr.forEach(itemSearcher);
function itemSearcher(value, index) {
...
namearr.forEach(spilitFunction);
function spilitFunction(value) {
...
var word_occurance = "the";
var count = 0;
var sentencearr = sentence.split(" ");
sentencearr.forEach(myFunction);
function myFunction(value) {
    if (value.toLowerCase() == word_occurance.toLowerCase()) {
        count = count + 1;
    }
}
document.write("There are " + count + " occurence(s) of word '" + word_occurance + "'");
...
//task 11
function fix (input_sentence)
{
    var a=input_sentence.split(" ");
